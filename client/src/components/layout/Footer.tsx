...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-96 h-96 bg-[#00A8E8]/10 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 right-0 w-80 h-80 bg-[#ECAA00]/10 rounded-full blur-3xl translate-x-1/3 translate-y-1/3" />
      ...
      <div className="relative container mx-auto px-8 lg:px-12">
        ...
        <div className="py-16 border-b border-gray-200">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h3 className="font-display text-3xl md:text-4xl text-gray-900 font-medium mb-6">
                Let's Work <span className="italic font-normal text-brand-cyan">Together</span>
              </h3>
              <div className="space-y-4">
                <a 
                  href="mailto:inquiry@paralight.cc" 
                  className="flex items-center gap-4 text-xl md:text-2xl text-gray-800 hover:text-brand-cyan transition-colors group"
                >
                ...
                <a 
                  ...
                  className="flex items-center gap-4 text-xl md:text-2xl text-gray-800 hover:text-brand-gold transition-colors group"
                >
              ...
              <div className="flex items-start gap-4 mt-6 text-gray-500">
            ...
            <div className="lg:text-right">
              <h4 className="text-[11px] font-medium uppercase tracking-[0.3em] text-gray-500 mb-6">
                Follow Us
              </h4>
              <div className="flex flex-wrap lg:justify-end gap-3">
                {socials.map((social) => (
                  <a 
                    ...
                    className="w-14 h-14 flex items-center justify-center rounded-xl bg-white shadow-sm border border-gray-100 text-gray-500 hover:text-white transition-all duration-300 hover:scale-110 hover:-translate-y-1"
                    onMouseEnter={(e) => {
        ...
        {/* Bottom bar */}
        <div className="relative py-6 border-t border-gray-200">
